...
// These constants are upper bound on various features of the world
// in which your bot must operate.  You may not need to use
// any of them in your program.  The actual values for these features
// will vary but will always be <= the constans below.
...
// only one instance of this struct iscreated for each commodity
//
...
// get_action is called once every turn to get to get a bot's action
...
// but note you can not have a function of the same name with a different prototype
